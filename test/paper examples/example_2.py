...
B[0,0]=0
#B[1,0]=0
A=0.995*np.eye(n)+np.random.randint(-100,100,size=(n,n))*0.01*0.005
C=np.zeros((o,n))
C[0,0]=1
#C[1,1]=1
D=np.eye(n)[0:z,:]
...
ax.set_xlabel("Re")
ax.set_ylabel("Im")
fig.savefig('figures/Example2_poles', dpi=100)
...
#    fig2, ax2 = plt.subplots()
    ...
    ax1.set_ylabel(r'$u_1$',fontsize=26)
...
#    ax2.set_title(r'Error of Observer State')
    ...
    for i in range(N):
        ...
        for method in keys:
            ...
            fig0.savefig('figures/Example2_u', dpi=100)
        ...
        for method in keys:
            ...
            fig1.savefig('figures/Example2_u', dpi=100)
        handles, labels = ax0.get_legend_handles_labels()
